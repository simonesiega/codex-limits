/**
 * @fileoverview Behavioral coverage for agent uninstall. The cases document the supported contract and isolate filesystem, network, or host state where applicable.
 */
