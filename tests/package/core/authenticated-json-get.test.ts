/**
 * @fileoverview Behavioral coverage for authenticated json get. The cases document the supported contract and isolate filesystem, network, or host state where applicable.
 */
