/**
 * @fileoverview Behavioral coverage for usage normalizer. The cases document the supported contract and isolate filesystem, network, or host state where applicable.
 */
