# Codex Limits Documentation Hub

[← Project README](../README.md) · [npm package](https://www.npmjs.com/package/@simonesiega/codex-limits)

This documentation is organized by task. The root README is the product overview, while the guides below provide the canonical reference for specific areas.

[Compatibility](guides/compatibility.md) owns support requirements, [`SECURITY.md`](../SECURITY.md) owns deep safety behavior, [Troubleshooting](guides/troubleshooting.md) owns cross-surface diagnosis, and each agent guide owns that integration's setup, removal, and troubleshooting.
...
- **Contributing?** Start with [Contributing](../CONTRIBUTING.md), beginning with [Finding work](../CONTRIBUTING.md#finding-work).
