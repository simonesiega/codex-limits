/**
 * @fileoverview Ink presentation component for usage card. It renders display-ready values only; data access, normalization, and safety decisions belong to the shared core.
 */
