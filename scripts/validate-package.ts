...
try {
  ...
  for (const required of [
    ...
    "docs/examples/codex-limits-coupons-output.example.json",
    "docs/examples/codex-limits-doctor-output.example.json",
    "docs/guides/agent-integrations.md",
    "docs/guides/agents/copilot.md",
    "docs/guides/agents/opencode.md",
